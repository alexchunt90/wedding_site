...
const Jumbotron = () =>
	<div className='jumbotron jumbotron_main parallax-window d-flex h-100 flex-grow' data-parallax='scroll' data-image-src='/static/images/bg.jpg' data-position-y='0px' data-ios-fix='true'>
		<Anchor id='home' />
